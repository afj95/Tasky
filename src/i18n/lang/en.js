export default {
    app: {
        ...
        idStartDateHijri: "ID StartDate Hijri",
        ...
        workOfficeNumber: "Work Office Number",
        orgNumber: "OrgNumber",
        position: "Position",
        birthdate: "Birthdate",
        ...
        showed: "Show it in application",
        showedHelpText: "Will shown in the application only if the status is active",
